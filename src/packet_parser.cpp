...
// This file uses the portable conversions from platform.h rather than the
// system ones. On platforms where <sys/_endian.h> has already defined ntohs/ntohl
// as macros (macOS does, via the standard headers above), redefining them without
// undefining first is a hard error under -Werror and a warning otherwise.
#ifdef ntohs
#undef ntohs
#endif
#ifdef ntohl
